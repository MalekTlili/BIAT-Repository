		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "BIAT",
									"targetURL": "#biatfioriapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"biatfioriapp-display": {
								"semanticObject": "biatfioriapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=biat.fiori.app",
									"url": sap.ui.require.toUrl("biat/fiori/app")
								}
							}
						}
					}
